...
namespace RPG.CameraUI
{
    public class CameraRaycaster : MonoBehaviour
    {
        ...
        public delegate void OnRightClick(RaycastHit raycastHit, int layerHit); // declare new delegate type for the right click
        public event OnRightClick notifyRightClickObservers; // instantiate an observer set for the right click
